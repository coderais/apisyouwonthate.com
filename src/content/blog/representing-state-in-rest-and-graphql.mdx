...
A [recent talk from Mike Amundsen](http://www.amundsen.com/talks/2017-04-craftconf/index.html) goes through a number of topics, but specifically Hypermedia (HATEOAS) as a collection of affordances (potential actions that can taken). This quote was up in there:
